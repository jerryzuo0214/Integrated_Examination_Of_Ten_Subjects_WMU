...
<img src="https://s3.ax1x.com/2021/01/26/sjU8hQ.png" width="30" alt="答题卡"/>答题卡中确认已经做过的题并选择没做过的题目继续练习，当您做完所有的题目后想重新再练习，您或许需要此功能来清除记录。当然，如果您需要把收藏夹或错题本清空，这里也有相应的选项。
>>>！！WARNING ！！`清空练习记录`选项会把所有科目的练习记录全部清空，因此应慎重选择，如果您想清空单独一个科目的练习记录，请去该科目的练习模式中点击<img src="https://s3.ax1x.com/2021/01/26/sjNTO0.png" width="30" alt="清空记录"/>`清空记录`按钮进行清空哦！！
