...
>`各类清除选项`给了大家机会去清除做题的记录，以便重新刷题。我们设计的逻辑是这样子的，在练习模式中，已经做过的题目会保存答案并记录进度，因此您可以在退出练习后仍能够保存之前的做题记录，在下一次进入练习模式后可以简便的在答题卡中确认已经做过的题并选择没做过的题目继续练习，当您做完所有的题目后想重新再联系，您或许需要此功能来清除记录。当然，如果您需要把收藏夹或错题本清空，这里也有相应的选项。

！！但应注意！！`清空练习记录`选项会把所有科目的记录全部清空，因此应慎重选择，如果您想清空单独一个科目的练习记录，请去该科目的练习模式中点击`清空记录`按钮进行清空哦！！
